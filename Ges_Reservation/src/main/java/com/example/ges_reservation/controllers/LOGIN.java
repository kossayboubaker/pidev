...
public class LOGIN {
    ...
    void verspageadus(ActionEvent event) throws SQLException {
        ...
        if ((email.equals("azerbenamoradmin@gmail.com") && mdp.equals("azeradmin")) ||
            ...
            navigateToPage("/back.fxml", event);
        } else {
            ...
            try {
                ...
                if (user != null) {
                    ...
                    navigateToPageUser("/front.fxml", event, user);
                } else {
    ...
    private void navigateToPageUser(String pagePath, ActionEvent event, User user) {
        try {
            ...
            com.example.ges_reservation.controllers.FrontFXMLController controller = loader.getController();
    ...
    void PageOubliermdp(ActionEvent event) {
        FXMLLoader fxmlLoader = new FXMLLoader(MainFX.class.getResource("/MotDePasseOublier.fxml"));
        try {
    ...
    void pageSignUp(ActionEvent event) {
        FXMLLoader fxmlLoader = new FXMLLoader(MainFX.class.getResource("/SignUp.fxml"));
        try {
            LogInMdp.getScene().setRoot(fxmlLoader.load());
        } catch (IOException e) {
            System.err.println(e.getMessage());
    ...
    void ToReclamation(ActionEvent event) {
        FXMLLoader fxmlLoader = new FXMLLoader(MainFX.class.getResource("/Reclamation.fxml"));
        try {
            LogInMdp.getScene().setRoot(fxmlLoader.load());
        } catch (IOException e) {
            System.err.println(e.getMessage());
