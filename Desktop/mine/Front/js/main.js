...
(function(html) {
    ...
    * ------------------------------------------------------ */
    ...
    const myHeading = document.getElementById('Read-Now');

    myHeading.addEventListener('mouseover', () => {
      myHeading.style.color = 'white'; // Change the color to red
    });
    
    myHeading.addEventListener('mouseout', () => {
      myHeading.style.color = ''; // Reset the color back to its original value
    });
