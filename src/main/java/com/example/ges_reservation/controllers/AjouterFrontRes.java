...
public class AjouterFrontRes {
    ...
    private void genererPDF(List<String> selectedSiegeNumbers) {
        try {
            ...
            ticketParagraph.add(" Référence de réservation: ReservationId").setFontSize(14);
            ...
            document.add(new Paragraph("Merci de vous référer à notre site web pour les conditions de vente.")).setFontSize(15);
